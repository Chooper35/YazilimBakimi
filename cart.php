...
<div class="container col-9 mt-4">
    ...
    <div class="col-12 ml-auto mr-auto mt-4">
        <div class="row text-center">
            ...
            if ($query) :
                    ...
                    <div class="col-12 col-md-6 col-lg-4 border">
                        <div class="productImage mb-2"><img src="/images/products/<?=$query['photo']?>" alt="<?=$query['photo']?>" width="220px" height="180px"></div>
                        <div class="productName mb-1"> <?=$query['product_name']?> </div>
                        <div class="productDetails mb-1"> <?=$query['details']?> </div>
                        <div class="productPrices"> <?=$query['price']?> </div>
                        <button id="<?=$query['id']?>remove" class="btn btn-danger" onclick="removeFromChartAndRefresh(this.id, <?=$query['id']?>)"> Remove From Chart </button>
                    </div>
        ...
        <div id="totalPrice" class="text-center mt-5"> Total Cart Price = <span style="font-size:24px; font-weight: bold"> <?=$totalPrice?> </span> </div>
    </div>
</div>
