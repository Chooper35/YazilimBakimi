...
if (isset($_POST['productName'], $_POST['productDescription'], $_POST['productPrice'])) {
    try {
        ...
        if($_FILES["productImage"]["size"] > 5*1024*1024) {
            $_SESSION['imageUploadSizeError'] = '<div class="container col-6 mt-5"><div class="alert alert-danger" role="alert">
            Product Images file size can\'t higher than 5 MB!
            </div></div>';
        } else {
    ...
    unset($_SESSION['imageUploadSizeError']);
}

if (isset($_SESSION['productAdded'])) {
    echo $_SESSION['productAdded'];
} else if (isset($_SESSION['imageUploadSizeError'])) {
    echo $_SESSION['imageUploadSizeError'];
}
?>
            ...
            <form action="" method="post" class="bg-dark text-white p-4 mt-3" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <textarea id="productDescription" name="productDescription" class="form-control" rows="4"
                        placeholder="Enter product details here.." required></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="productPrice" name="productPrice" class="form-control" type="number" min="0" value="1"
